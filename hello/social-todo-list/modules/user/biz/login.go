...
// 4. Return token(s)
func (business *loginBusiness) Login(ctx context.Context, data *models.UserLogin) (tokenprovider.Token, error) {
	...
	err = business.hasher.Compare(user.Password, data.Password+user.Salt)
